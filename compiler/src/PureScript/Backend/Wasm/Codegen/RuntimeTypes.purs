...
buildRuntimeTypes _ = do
  ...
  main <- B.typeBuilderBuildAndDispose tb 10
  case main of
    [ valsHt, intHt, cloHt, labelIdsHt, recHt, numHt, bytesHt, strHt, i32ArrHt, f64ArrHt ] -> do
    ...
    _ -> throwException (error "Codegen: expected exactly 10 runtime heap types")
